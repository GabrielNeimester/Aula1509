...
export default function Tarefas(){
    return(
        ...
        <GridItem colSpan={10} rowSpan={1}>
        <Titulo tag="h2" label="Inserir Nova Tarefa"></Titulo>
        </GridItem>

        <GridItem colSpan={8} rowSpan={1}>
        <InputChakraUi placeholder="Digite uma task"></InputChakraUi>
        </GridItem>

        <GridItem colSpan={1} rowSpan={1} gap={2} justifySelf="center" alignSelf="center">
        <CheckboxChakraUi label="Realizada?"></CheckboxChakraUi>
        </GridItem>

        
        <GridItem colSpan={1} rowSpan={1} gap={2}>
        <ButtonChakraUi color="blue" label="Inserir"></ButtonChakraUi>
        </GridItem>
